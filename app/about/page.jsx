...
import img1 from "@/public/others/about-1.jpg"
    ...
    return (
      <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
        ...
        <div className="col-span-2 relative aspect-square">
          <Image src='/others/about-2.jpg' width={500} height={100} className="object-cover"  alt="Family that manages The Wild Oasis" />
        </div>
